...
private_onenode_blueprint_user = Blueprint(
    "private_onenode_user", __name__, url_prefix="/user"
)


@private_onenode_blueprint_user.route("", methods=["POST"])
...
@private_onenode_blueprint_user.route("/email", methods=["GET"])
@require_admin_api_key
...
@private_onenode_blueprint_user.route("/token", methods=["GET"])
