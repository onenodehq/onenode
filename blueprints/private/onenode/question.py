...
from blueprints.v0.utils.question_helper import (
    docs_to_context,
...
private_onenode_blueprint_question = Blueprint(
    "question", __name__, url_prefix="/question"
)


@private_onenode_blueprint_question.route("", methods=["POST"])
...
def generate_response():
    ...
    mongo_docs = list(
        mongo_onenode_contents.find(filter=mongo_filter, projection={"_id": 0})
    )
