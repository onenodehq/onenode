...
@v0_blueprint_doc_anon.route("", methods=["POST"])
def create_docs_anon(db_id: str, collection_name: str):
...
@v0_blueprint_doc_anon.route("", methods=["PUT"])
def update_docs_anon(db_id: str, collection_name: str):
    project_id, db_name = split_db_id(db_id)
    g.plan = "free"
    create_anon_project_if_not_exists(project_id)
...
@v0_blueprint_doc_anon.route("", methods=["DELETE"])
def delete_docs_anon(db_id: str, collection_name: str):
    project_id, db_name = split_db_id(db_id)
    g.plan = "free"
    create_anon_project_if_not_exists(project_id)
