...
MONGO_INDEX_COLLECTION = os.getenv("MONGO_INDEX_COLLECTION")
MONGO_INDEX_DB_NAME = os.getenv("MONGO_INDEX_DB_NAME")
...
mongo_index_collection = mongo_db.get_collection(MONGO_INDEX_COLLECTION)
mongo_index_db = mongo_client.get_database(MONGO_INDEX_DB_NAME)
